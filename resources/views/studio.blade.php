...
<div class="py-vh-5 w-100 overflow-hidden">
    <div class="container ">
        <div class="row d-flex ">
            <div class="col-md-6 ">
                <div class="py-vh-5">
                <h1 class="display-3 text-figure " data-aos="fade-down">Travaux et réalisation</h1>
                </div>
            </div>
    ...
    <div class="py-vh-5  d-flex justify-content-center align-items-center">
        <h2 class="display-3 text-figure " data-aos="fade-down">Réalisation</h2>
    </div>
  ...
  <!-- <figure class="containre-figure">
                            <div class="img-comp-container">
                                <div class="img-comp-img">
                                    <img src="{{asset('img/ja/renive_2.jpg')}}" alt="" width="520" height="720">
                                </div>
                                <div class="img-comp-img img-comp-overlay">
                                    <img src="{{asset('img/ja/renove_1.jpg')}}" alt=""width="520" height="720">
                                </div>
                                </div>
                            </div>
                    </figure> -->
