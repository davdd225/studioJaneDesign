<footer class="bg-jane  nav-jane-police">
    ...
    <div class="col-12 col-lg-6 col-xl-3 border-end p-5">
    <h3 class="h6 mb-3">Studio</h3>
    <ul class="nav flex-column">
        <li class="nav-item">
        <a class="nav-link link-secondary ps-0" aria-current="page" href="{{url('/studio')}}">Galerie</a>
        </li>
    </ul>
    </div>
    <div class="col-12 col-lg-6 col-xl-3 p-5">
    <h3 class="h6 mb-3">Contacts</h3>
    <ul class="nav flex-column">
        <li class="nav-item">
        <a class="nav-link link-secondary ps-0" aria-current="page" href="{{url('/contact')}}">Formulaire</a>
        </li>
    </ul>
    </div>
    </div>
    </div>
    <div class="container text-center py-3 small">Copyright 2023 Made by David Agouassi tout droit reservé <a href="" class="link-fancy" target="_blank"></a>
    </div>
</footer>
